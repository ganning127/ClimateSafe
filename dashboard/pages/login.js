...
export default function Login() {
  ...
  useEffect(() => {
    if (localStorage.getItem("climatesafe_login_state") === "true") {
  ...
  const handleLogin = async (event) => {
    ...
    setTimeout(async () => {
      ...
      if (data.success) {
        window.location = "/dashboard";
        localStorage.setItem("climatesafe_login_state", true);
        setError(false);
      } else {
            ...
            <Stack direction={"row"} spacing={4} align={"center"}>
              ...
              <Flex
                ...
                _before={{
                  ...
                  rounded: "full",
                  transform: "scale(1.125)",
                  bgGradient: "linear(to-bl, lightgreen, darkgreen)",
                  position: "absolute",
                  zIndex: -1,
                  top: 0,
                  left: 0,
            ...
            <Stack spacing={4}>
              ...
              <Box d="flex" alignItems="center">
                <Flex alignItems="center">
                  <Img src="/logo.png" h="60px" d="inline" />
              ...
              <Box bg="lightgreen" rounded="md" p={3}>
                <Box>
            ...
            <Formik>
              <Form onSubmit={handleLogin}>
                ...
                <Button
                  ...
                  transition="all 0.2s"
                  _hover={{
                    bgGradient: "linear(to-r, lightgreen, darkgreen)",
                  }}
                >
